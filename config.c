...
static struct config_enum nw_trans_enu[] = {
	...
	{ "PTPv1_UDPv4", TRANS_V1_UDP_IPV4_NP },
	{ "PTPv1_UDPv6", TRANS_V1_UDP_IPV6_NP },
	{ NULL, 0 },
};
...
struct config_item config_tab[] = {
	...
	GLOB_ITEM_INT("ptpv1_dscp_event", 0, 0, 63),
	GLOB_ITEM_INT("ptpv1_dscp_general", 0, 0, 63),
	PORT_ITEM_STR("ptpv1_dst_ipv4", NULL),
	PORT_ITEM_STR("ptpv1_dst_ipv6", NULL),
	PORT_ITEM_STR("ptpv1_domain_map", "0:_DFLT 1:_ALT1 2:_ALT2 3:_ALT3"),
	PORT_ITEM_STR("ptpv1_clockClass_map", "6:0 7:0 9:1 10:2 13-248:3 251:4 255:255"),
	PORT_ITEM_STR("ptpv1_priority1_map", "0-126:1,0 127:1,* 128:0,* 129-255:0,255"),
	PORT_ITEM_STR("ptpv1_priority2_map", "0-127:1 128-255:0"),
	PORT_ITEM_INT("ptpv1_udp6_scope", 0x0E, 0x00, 0x0F),
